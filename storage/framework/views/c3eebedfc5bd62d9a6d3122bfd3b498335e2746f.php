        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <?php if(is_default_lang()): ?>
                    ...
                    <div class="form-group" data-condition="enable_preloader:is(1)">
                        <label><?php echo e(__("Preloader Image")); ?></label>
                        <div class="form-controls form-group-image">
                            <?php echo \Modules\Media\Helpers\FileHelper::fieldUpload('preloader_image',$settings['preloader_image'] ?? ''); ?>
...
<?php /**PATH /home/eyinka/projects/gradx/modules/Core/Views/admin/settings/groups/style.blade.php ENDPATH**/ ?>