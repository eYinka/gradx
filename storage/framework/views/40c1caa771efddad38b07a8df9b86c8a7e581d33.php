    ...
    <script>
        ...
        if($("#bc_results_map").length) {
            var bravo_map_data = {
                ...
                center: [<?php echo e(!empty($markers[0]['lat']) ? $markers[0]['lat'] : setting_item('default_location_lat', "51.505")); ?>, <?php echo e(!empty($markers[0]['lng']) ? $markers[0]['lng'] : setting_item('default_location_lng', "-0.09")); ?>]
            };
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eyinka/projects/gradx/modules/Job/Views/frontend/index.blade.php ENDPATH**/ ?>