...
<div class="header-widgets d-flex flex-grow-1">
    ...
    <div class="widgets-right flex-shrink-0 d-flex">
        ...
        <div class="dropdown header-widget widget-user flex-shrink-0">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?php echo e(route('user.admin.detail',['id'=>Auth::id()])); ?>"><?php echo e(__('Edit Profile')); ?></a>
...
<?php /**PATH /home/eyinka/projects/gradx/modules/Layout/admin/parts/header.blade.php ENDPATH**/ ?>